/* Taken from http://www.lukemelia.com/blog/archives/2012/03/10/using-ember-js-with-jquery-ui/ */
...
JQ.Widget = Em.Mixin.create({
	...
	didInsertElement: function() {
		...
		var namespace = this.get('namespace') || 'ui';
		var ui = jQuery[namespace][this.get('uiType')](options, this.get('element'));
	...
	_gatherOptions: function() {
		var uiOptions = this.getWithDefault('uiOptions', []), options = {};
